      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 mt-8">
          ...
          <form className="space-y-2" onSubmit={(e) => { e.preventDefault(); const v = (e.target as any).shares.value; onWithdraw(v); }}>
            <label className="block text-sm font-medium text-white" htmlFor="vault-withdraw">Withdraw sUSDK</label>
            <div className="flex items-center gap-2">
              <input id="vault-withdraw" name="shares" type="number" step="any" placeholder="sUSDK to withdraw" className="w-full rounded-md border px-3 py-2 text-gray-900 bg-gray-50" />
