...
export default function PoolPage() {
  return (
    <PageShell title="Pool" subtitle="Protocol liquidity and markets overview.">
      <Card>
        ...
        <div className="mt-6 flex items-center justify-between">
          <div className="text-sm text-slate-300">For now, use the vault pages to interact with the protocol.</div>
          <Link href="/vault">
