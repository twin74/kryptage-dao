...
import { DocContentPart1 } from "./DocContentPart1";
import { DocContentPart2 } from "./DocContentPart2";
...
function DocContent({ chapter }: { chapter: DocChapterId }) {
  // Split to keep this file small.
  if (chapter === "get-started" || chapter === "ecosystem" || chapter === "usdk" || chapter === "products" || chapter === "ktg") {
    return <DocContentPart1 chapter={chapter} SectionTitle={SectionTitle} P={P} Li={Li} />;
  }

  if (chapter === "dao" || chapter === "developers" || chapter === "safety" || chapter === "compliance" || chapter === "faq" || chapter === "contacts") {
